...
{
    public static double R_u_CODATA
    {
        get
        {
            var ret = CoolPropPINVOKE.R_u_CODATA_get();
    ...
    {
        var ret = CoolPropPINVOKE.get_parameter_information(key, info);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = (parameters) CoolPropPINVOKE.get_parameter_index(param_name);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = (phases) CoolPropPINVOKE.get_phase_index(param_name);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.is_trivial_parameter(key);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.is_valid_parameter(name, SWIGTYPE_p_CoolProp__parameters.getCPtr(iOutput));
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.is_valid_first_derivative(name, SWIGTYPE_p_CoolProp__parameters.getCPtr(iOf),
    ...
    {
        var ret = CoolPropPINVOKE.is_valid_first_saturation_derivative(name,
            SWIGTYPE_p_CoolProp__parameters.getCPtr(iOf), SWIGTYPE_p_CoolProp__parameters.getCPtr(iWrt));
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.is_valid_second_derivative(name, SWIGTYPE_p_CoolProp__parameters.getCPtr(iOf1),
    ...
    {
        var ret = CoolPropPINVOKE.get_csv_parameter_list();
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = (input_pairs) CoolPropPINVOKE.get_input_pair_index(input_pair_name);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.get_input_pair_short_desc((int) pair);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.get_input_pair_long_desc((int) pair);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        CoolPropPINVOKE.split_input_pair((int) pair, SWIGTYPE_p_CoolProp__parameters.getCPtr(p1),
    ...
    {
        var ret = CoolPropPINVOKE.get_mixture_binary_pair_data(CAS1, CAS2, param);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.Props1SI(FluidName, Output);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.PropsSI(Output, Name1, Prop1, Name2, Prop2, FluidName);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }

    public static SWIGTYPE_p_std__vectorT_std__vectorT_double_t_t PropsSImulti(
        SWIGTYPE_p_std__vectorT_std__string_t Outputs, string Name1, DoubleVector Prop1, string Name2,
        DoubleVector Prop2, string backend, SWIGTYPE_p_std__vectorT_std__string_t fluids, DoubleVector fractions)
    {
        var ret =
            new SWIGTYPE_p_std__vectorT_std__vectorT_double_t_t(
                CoolPropPINVOKE.PropsSImulti(SWIGTYPE_p_std__vectorT_std__string_t.getCPtr(Outputs), Name1,
                    DoubleVector.getCPtr(Prop1), Name2, DoubleVector.getCPtr(Prop2), backend,
                    SWIGTYPE_p_std__vectorT_std__string_t.getCPtr(fluids), DoubleVector.getCPtr(fractions)), true);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.get_debug_level();
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.saturation_ancillary(fluid_name, output, Q, input, value);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.get_global_param_string(ParamName);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.get_fluid_param_string(FluidName, ParamName);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.is_valid_fluid_string(fluidstring);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.get_BibTeXKey(FluidName, item);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.PhaseSI(Name1, Prop1, Name2, Prop2, FluidName);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        CoolPropPINVOKE.extract_backend(fluid_string, SWIGTYPE_p_std__string.getCPtr(backend),
    ...
    {
        var ret = CoolPropPINVOKE.extract_fractions(fluid_string, DoubleVector.getCPtr(fractions));
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.get_config_bool((int) key);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.get_config_string((int) key);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.get_config_as_json_string();
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    public static double HAPropsSI(string OutputName, string Input1Name, double Input1, string Input2Name, double Input2,
        string Input3Name, double Input3)
    {
        var ret = CoolPropPINVOKE.HAPropsSI(OutputName, Input1Name, Input1, Input2Name, Input2, Input3Name, Input3);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    public static double HAProps(string OutputName, string Input1Name, double Input1, string Input2Name, double Input2,
        string Input3Name, double Input3)
    {
        var ret = CoolPropPINVOKE.HAProps(OutputName, Input1Name, Input1, Input2Name, Input2, Input3Name, Input3);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.HAProps_Aux(OutputName, T, p, W, units);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.IceProps(Name, T, p);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.returnHumAirCode(Code);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        var ret = CoolPropPINVOKE.cair_sat(T);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
}